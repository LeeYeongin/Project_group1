package com.project.team_1.config;
...
import com.project.team_1.filter.JwtAuthencationFilter;
...
public class WebSecurityConfig {
	...
	protected SecurityFilterChain configure (HttpSecurity httpSecurity) throws Exception {
		httpSecurity
			...
			.authorizeHttpRequests().antMatchers("/", "/api/auth/**", "/api/carousel/**", "/api/main5/**", "/api/list/**", 
					"/api/cart/**", "/api/orderlist/**").permitAll()
